          ...
          <div className="lg:col-span-8">
            ...
            {activeTab === 'orders-tab' && (
              <div id="orders-tab" className="tab-content bg-slate-800 border border-slate-700 rounded-2xl p-6 md:p-8 shadow-lg shadow-slate-950/20">
                ...
                <div className="flex flex-col gap-5">
                  <div className="border border-slate-700/80 rounded-xl p-4 bg-slate-900/30 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-white">Order #EZ-10023</div>
                        <div className="text-xs text-slate-400">27 May 2026 &bull; 2 Items &bull; Rs. 386</div>
                        <div className="text-[10px] text-slate-500 mt-1">Harpic Cleaner Range, Godrej No.1 Aloe Soap</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end gap-1 text-right">
                      <span className="bg-teal-400/10 text-teal-400 font-bold text-[10px] uppercase px-2.5 py-1 rounded-full border border-teal-400/20">Delivered</span>
                      <span className="text-[10px] text-slate-500">Delivered on 28 May 2026</span>
                    </div>
                  </div>
                  ...
                  <div className="border border-slate-700/80 rounded-xl p-4 bg-slate-900/30 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-slate-800 border border-slate-700 rounded-lg flex items-center justify-center text-sm font-bold text-teal-400">EZ</div>
                      <div>
                        <div className="text-sm font-semibold text-white">Order #EZ-10012</div>
                        <div className="text-xs text-slate-400">14 May 2026 &bull; 1 Item &bull; Rs. 149</div>
                        <div className="text-[10px] text-slate-500 mt-1">Colgate Strong Teeth Toothpaste</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end gap-1 text-right">
                      <span className="bg-teal-400/10 text-teal-400 font-bold text-[10px] uppercase px-2.5 py-1 rounded-full border border-teal-400/20">Delivered</span>
                      <span className="text-[10px] text-slate-500">Delivered on 14 May 2026</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'addresses-tab' && (
              <div id="addresses-tab" className="tab-content bg-slate-800 border border-slate-700 rounded-2xl p-6 md:p-8 shadow-lg shadow-slate-950/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="border border-slate-700/80 rounded-xl p-4 bg-slate-900/30 relative">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-teal-400 text-xs font-bold mr-1">HOME</span>
                      <span className="text-sm font-bold text-white">Home Address</span>
                      <span className="text-[9px] bg-teal-400/10 border border-teal-400/30 text-teal-400 font-semibold px-2 py-0.5 rounded-full ml-auto">Default</span>
                    </div>
                    ...
                    <div className="mt-4 flex gap-3 text-[10px]">
                      <button className="text-teal-400 font-bold hover:underline">Edit</button>
                      <button className="text-rose-400 font-bold hover:underline">Delete</button>
                    </div>
                  </div>

                  <div className="border border-slate-700/80 rounded-xl p-4 bg-slate-900/30 relative">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-teal-400 text-xs font-bold mr-1">OFFICE</span>
                      <span className="text-sm font-bold text-white">Office Address</span>
                    </div>
                    <p className="text-xs text-slate-300 leading-relaxed">
                      45, Tech Park, OMR,<br />
                      Chennai, TN - 600096
